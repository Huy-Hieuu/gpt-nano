...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Calculate query, key, values for all heads in batch and split into heads
        ...
        if self.flash:
            ...
            # Efficient attention with Flash Attention CUDA kernels
...
class Block(nn.Module):
    """Transformer block: Pre-LN + Attention + Residual + Pre-LN + MLP + Residual."""
